/*
 * Minimal "Hello" example for LVGL + WiFi (or Bluetooth) on Adafruit FunHouse ESP32-S2.
 *
 * This example demonstrates usage of an ESP32 running LVGL and WiFi (or Bluetooth) simultaneously.
 *
 * Full details around LVGL_Glue's enhancements for LVGL/WiFi: https://github.com/adafruit/Adafruit_LvGL_Glue/pull/22
 *
 * Requires LittlevGL, Adafruit_LvGL_Glue, Adafruit_GFX and Adafruit_ST7735 libraries.
 *
...
void lvgl_setup(void) {
  ...
  lv_obj_t *label = lv_label_create(lv_scrr_act());
