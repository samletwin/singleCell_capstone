  ...
  <body style="background-color: #efefef" onload="process()">
    ...
    <header>
      <div class="navbar fixed-top">
          <div class="container">
            <div class="navtitle">Battery SOH Test Monitor</div>
    ...
    <main class="container" style="margin-top:70px">
      ...
      <tr>
        <td><div class="bodytext">Battery Voltage - ADC CH0 </div></td>
        <td><div class="tabledata" id = "b0"></div></td>
        <td><div class="tabledata" id = "v0"></div></td>
      </tr>
      <tr>
        <td><div class="bodytext">Battery Current - ADC CH1 </div></td>
        <td><div class="tabledata" id = "b1"></div></td>
        <td><div class="tabledata" id = "v1"></div></td>
      </tr>
        <tr>
        <td><div class="bodytext">Current Measurement digital switch</div></td>
        <td><div class="tabledata" id = "switch"></div></td>
      </tr>
      </table>
    </div>
